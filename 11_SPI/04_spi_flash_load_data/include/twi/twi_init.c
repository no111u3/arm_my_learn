 ...
 */
// TWI enable i/o pins
static void twi_pio_enable(void) {
    // enable pio
...
// TWI setup mode
static void twi_set_mode(const unsigned char mode) {
    // disable interrupts
...
// TWI setup clock
static void twi_set_clock(const unsigned master_clock, const unsigned twi_clock) {
    unsigned int sclock;
...
// TWI init
static void twi_init(const unsigned char mode, const unsigned master_clock, const unsigned twi_clock) {
    // enable twi pio
    twi_pio_enable();
