...
*/
// putting char
extern void put_char(unsigned int character) {
...
// putting string
extern void put_string(const unsigned char * buffer) {
    while (*buffer) {
        put_char(*buffer++);
    }
}
// getting string
void get_string(unsigned char * buffer,unsigned int size, unsigned int in_out) {
